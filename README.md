...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/executorlib-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/executorlib-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add executorlib
# for installing globally
pixi global install executorlib
```
...
It is possible to list all of the versions of `executorlib` available on your platform:
...
```
pixi search executorlib --channel conda-forge
```
